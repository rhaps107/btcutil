...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/rhaps107/btcutil/coinset)
...
```bash
$ go get -u github.com/rhaps107/btcutil/coinset
```
